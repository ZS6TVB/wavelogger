...
i = 1
print ("Sample #,Date_Time,V1,I1,P1,V2,I2,P2,V3,I3,P3,V4,I4,P4")
...
try:
    while True:
        ...
        print(f'{i},{datetime.datetime.now()},{bus_voltage1 + shunt_voltage1:.3f},{current1/1000:.3f},{power1:.3f},{bus_voltage2 + shunt_voltage2:.3f},{current2/1000:.3f},{power2:.3f},{bus_voltage3 + shunt_voltage3:.3f},{current3/1000:.3f},{power3:.3f},{bus_voltage4 + shunt_voltage4:.3f},{current4/1000:.3f},{power4:.3f}')
        i = i+1
        time.sleep(1)
